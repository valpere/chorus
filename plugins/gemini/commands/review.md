---
description: Run a Gemini code review on the current git working tree
argument-hint: "[--wait|--background]"
disable-model-invocation: true
allowed-tools: Read, Glob, Grep, Bash(node:*), Bash(git:*), AskUserQuestion
---

Run a Gemini code review against the current git state and return its output verbatim.
...
```
- Tell the user: "Gemini review started in the background."
