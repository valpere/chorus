---
description: Run a Kilo Code review on the current git working tree
argument-hint: "[--wait|--background]"
disable-model-invocation: true
allowed-tools: Read, Glob, Grep, Bash(node:*), Bash(git:*), AskUserQuestion
---

Run a Kilo Code review against the current git state and return its output verbatim.
...
Bash({
  ...
  description: "Kilo review",
  run_in_background: true
})
```
- Tell the user: "Kilo review started in the background."
